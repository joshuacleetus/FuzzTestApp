...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CGRect textHeight = [self.resultsDict[@"data"]
                        ...
                        context:nil];
    return textHeight.size.height+120;
    }
    return 40;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.resultsDict[@"type"] isEqualToString:@"text"]|| [self.resultsDict[@"type"] isEqualToString:@"other"]) {
        ...
        //Initialize Label
        UILabel *lbl1 = [[UILabel alloc]initWithFrame:CGRectMake(20, 10, self.view.frame.size.width-40, textHeight.size.height)];
        lbl1.numberOfLines = 0;
        [lbl1 setFont:[UIFont systemFontOfSize:14]];
        [lbl1 setTextColor:[UIColor grayColor]];
        lbl1.text = @"";
        [cell addSubview:lbl1];
        
        UILabel *lbl2 = [[UILabel alloc]initWithFrame:CGRectMake(20, lbl1.frame.size.height+20, self.view.frame.size.width-40, 20)];
        ...
        if (self.selectedCellIndex == indexPath.row) {
            lbl1.text = [NSString stringWithFormat:@"data:%@",self.resultsDict[@"data"]];
